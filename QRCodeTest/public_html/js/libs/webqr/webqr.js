...
function setwebcam()
{
    ...
    if (n.getUserMedia) {
        n.getUserMedia({video: {mandatory:{maxHeight:320, maxWidth:240},optional:[/*{sourceId:videoSource},*/ { facingMode: "environment" }]}, audio: false}, success, error);
    } else if (n.webkitGetUserMedia) {
        webkit = true;
        n.webkitGetUserMedia({video: {mandatory:{maxHeight:320, maxWidth:240},optional:[/*{sourceId:videoSource},*/ { facingMode: "environment" }]}, audio: false}, success, error);
    } else if (n.mozGetUserMedia) {
        moz = true;
        n.mozGetUserMedia({video: {mandatory:{maxHeight:320, maxWidth:240},optional:[/*{sourceId:videoSource},*/ { facingMode: "environment" }]}, audio: false}, success, error);
    }
};
